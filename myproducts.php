    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          if(isset($_SESSION['username'])){
            echo '<li class="active"><a href="myproducts.php">My Product</a></li>';
        ...
        <div class="row" style="margin-top:10px;">
          <div class="large-12">
            ...
            <table class=" thead-light">    
              ...
              <tbody>
              <?php
                $result = $mysqli->query('SELECT * from products where product_owner = '.$userId);
            ...
            <div class="large-12 columns" style="padding-left:0;">
              <center><a href= "product-add.php"  method="post"><input style="clear:both;"name="action" type="submit" class="button" value="Add New Product"></a></center>
            </div></td>
          </div>
        </div>
      </div>
